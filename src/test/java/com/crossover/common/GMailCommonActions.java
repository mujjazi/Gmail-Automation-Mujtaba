...
public class GMailCommonActions {
	...
	public void elementClick(WebDriver driver,String locator, String subject) {
		
		List<WebElement> a = driver.findElements(By.xpath(locator));
		System.out.println(a.size());
		            for(int i=0;i<a.size();i++){
		                System.out.println(a.get(i).getText());
		                if(a.get(i).getText().contains("me")){ 
		                    a.get(i).click();
		                }
		            }
	}
	...
	public void dismissAlerts(WebDriver driver) {
